...
<!DOCTYPE html>
<html lang="zh-CN"<?php if ($this->options->colorSchema): ?> data-theme="<?php $this->options->colorSchema(); ?>"<?php endif; ?>>
<head>
    ...
    <link rel="stylesheet" href="<?php $this->options->themeUrl('static/css/custom.css'); ?>">
    <?php $this->header(); ?>
</head>
...
<header class="site-navbar container-fluid">
    <nav>
        ...
        <ul>
            <li>
                <label for="nav-toggler" class="nav-toggler-btn" aria-label="导航菜单">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" role="img" aria-label="菜单图标"><line x1="3" y1="12" x2="21" y2="12" /><line x1="3" y1="6" x2="21" y2="6" /><line x1="3" y1="18" x2="21" y2="18" /></svg>
                </label>
            </li>
        </ul>
    </nav>
